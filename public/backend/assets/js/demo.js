...
//Chart
// Chart.js initialization with element check
var statisticsChartCanvas = document.getElementById('statisticsChart');
if (statisticsChartCanvas) {
    var ctx = statisticsChartCanvas.getContext('2d');
...
var dailySalesChartflag = document.getElementById('dailySalesChart');
if(dailySalesChartflag){
