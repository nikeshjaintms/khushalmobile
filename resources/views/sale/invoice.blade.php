...
<div class="container invoice-box mt-4">
    ...
    <table border="1" style="width:100%; border-collapse: collapse; font-size: 15px; margin: auto;">
        ...
        <tr>
            <td  style="text-align: center"><h3>Khushal Mobile & Computer</h3>
                <div style="font-size: 18px">Address:- Near Hanuman Mandir , Akkalkuwa , Dist.Nandurbar-425415(M.S.)</div>
            </td>
        </tr>
        <tr>
    ...
    <table border="1" style="width:100%; border-collapse: collapse; font-size: 15px; margin: auto;">
        <tr>
            <td colspan="7">
                <span class="bold"> CustomerName :-</span> {{$sale->customer->name}}
                <div><span class="bold">Address :-</span> {{$sale->customer->address}}</div>
                <div>Phone no:<span>{{$sale->customer->phone}} </span></div>
            </td>
            <td>Payment Type:- {{ config('constants.database_enum.sales.payment_method.name')[$sale->payment_method]  }} </td>
        </tr>
