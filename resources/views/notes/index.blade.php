                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                        <a href="{{ route('admin.daily-notes.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary"><i class="fas fa-plus"></i> Note</a>
...
<script>
    function deletevehicle_info(id) {
        var url = '{{ route("admin.daily-notes.delete", "id") }}'.replace("id", id);
