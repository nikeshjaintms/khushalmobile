            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('admin.daily-notes.update' , $dailyNote->id ) }}" id="transactionForm">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title" id="title" value="{{ $dailyNote->title  }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description" id="description" value="{{ $dailyNote->description  }}"
